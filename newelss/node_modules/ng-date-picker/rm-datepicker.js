...
(function () {
    ...
    Module.directive("rmDatepicker", ['rmDatepickerConfig', '$compile', '$filter', '$document',
        ...
        var link = function (scope, element, attrs, ngModel) {
            ...
            scope.mode = scope.mode || 'datepicker';
            scope.changeDate = scope.changeDate || angular.noop;
            ...
            scope.$watch('minDate', function() {
                conf.min = scope.minDate;
                updateLimit();
            });
            var isDP = scope.mode.toUpperCase() == "DATEPICKER";
            var isReached = {
                min: false,
                max: false
            };
            ...
            scope.go = function (oDate) {
                ...
                if( isDP && scope.state == conf.minState && scope.isActive.month(oDate) ) {
                    scope.show = false;
            ...
            if (isDP) {
                ...
                element.on('click', function() {
                    ...
                    var pos = {};
                    console.log(scope.minDate);
                    pos.top = element.parent().offsetHeight +1;
                    pos.left = 0;

                    scope.style = {top: pos.top + "px", left: pos.left + "px"};
                    togglePicker(true);
                    scope.style = {top: pos.top + "px", left: "0px"};
                    scope.$apply();
                });
